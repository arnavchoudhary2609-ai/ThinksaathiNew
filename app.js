  ...
  constructor() {
    ...
    this.sessionConfigs = {
      ...
      guided_meditation: {
        ...
        steps: [
          { phase: 'inhale', label: 'Inhale', duration: 4000, desc: 'Focus entirely on the sensation of breathing in.' },
          { phase: 'hold', label: 'Hold', duration: 1000, desc: 'Pause softly.' },
          { phase: 'exhale', label: 'Exhale', duration: 6000, desc: 'Let all other thoughts drift away into the stars.' },
          { phase: 'hold', label: 'Hold', duration: 1000, desc: 'Pause softly.' }
        ]
      }
    };
